...
DELIMITER $$
USE `insight_places`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `novosAlugueis_55`(lista VARCHAR(555), 
...
CALL novosAlugueis_55('Gabriel Carvalho,Erik Oliveira,Catarina Correia, Loreana Jesus', '8635', '2023-06-03', 7, 45);