...
(vClienteNome VARCHAR(15), vHospedagem VARCHAR(10), vDataInicio DATE, vDias INTEGER, vPrecoUnitariol DECIMAL(10,2))
BEGIN
...
CALL novoAluguel_44('Livia Fogaça', '8635', '2023-04-20', 10, 40);
CALL novoAluguel_44('Livia Fogaça', '8635', '2023-04-29', 10, 40);
